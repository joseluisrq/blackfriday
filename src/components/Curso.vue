                ...
                <div class="container" style="background-size: cover;">
                    <div class="row" style="background-size: cover;">
                        <div class="col-md-5 " style="background-size: cover;">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <h1>S/ {{Descuento_Mostrar(curso.precio_carrito)}}</h1>
                                    <h3>Antes S/ {{curso.precio_carrito}}<br>
                                    Ahorras S/ {{curso.precio_carrito-Descuento_Mostrar(curso.precio_carrito)}}</h3>
                                 <!--   <h1>{{Descuento(curso.precio_carrito)}}</h1>-->
                                </div>
                                <div class="col-md-12">
                                    <img src="https://cersa.org.pe/premium/assets/images/cont/seguro.svg" width="30px" alt="">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-4">
                                      <button class="btn btn-outline-danger"> Tengo un Cupón</button>  
                                
                                </div>
                                <div class="col-md-6">
                                     <input class="form-group" name="cupon"  type="text" v-model="cupon"  >
                                </div>
                                <div class="col-md-6">
                                    {{CalcularCupon(cupon)}}
                                </div>
                            </div>
                                <div class="p-2 mt-4" style="#474747; background-size: cover;">
...
export default {
 ...
 methods:{
      ...
      CalcularCupon(cupon){
          ...
          if(cupon=="CERSA10"){
              return parseFloat(this.precio_payu)-parseFloat(this.precio_payu)
          }
      }
